...
class ColorConstant {
  ...
  static Color gray900 = fromHex('#191a2c');
  ...
  static Color whiteForGlass20 = Colors.white.withOpacity(0.2);
  static Color whiteForGlass5 = Colors.white.withOpacity(0.05);
  static Color textPrimary = fromHex('002260');
  static Color primaryIcon = fromHex('#002260');
