...
class _AssertionError extends Error implements AssertionError {
  @pragma("vm:entry-point")
  _AssertionError._create(this._failedAssertion, this._url, this._line, this._column, this.message);
  ...
  external static _doThrowNew(int assertionStart, int assertionEnd, Object? message);
  @pragma("vm:external-name", "AssertionError_throwNewSource")
  external static _doThrowNewSource(String failedAssertion, int line, int column, Object? message);
...
class _TypeError extends Error implements TypeError, CastError {
  ...
  external static _throwNew(int location, Object srcValue, _Type dstType, String dstName);
...
class AbstractClassInstantiationError {
  @pragma("vm:entry-point")
  AbstractClassInstantiationError._create(this._className, this._url, this._line);
...
class NoSuchMethodError {
  ...
  @patch
  factory NoSuchMethodError.withInvocation(Object? receiver, Invocation invocation) = NoSuchMethodError._withInvocation;
  ...
  // unresolved method.
  @pragma("vm:entry-point", "call")
  static void _throwNew(Object receiver, String memberName, int invocationType, int typeArgumentsLength,
      Object? typeArguments, List? arguments, List? argumentNames) {
    throw new NoSuchMethodError._withType(
        receiver, memberName, invocationType, typeArgumentsLength, typeArguments, arguments, argumentNames);
  }

  // Deprecated constructor.
  @patch
  NoSuchMethodError(this._receiver, Symbol memberName, List? positionalArguments, Map<Symbol, dynamic>? namedArguments,
  ...
  static Map<Symbol, dynamic> _NamedArgumentsMap(List arguments, List argumentNames) {
  ...
  NoSuchMethodError._withType(
      ...
      : this._invocation = new _InvocationMirror._withType(
            ...
            invocationType,
            _InvocationMirror._unpackTypeArguments(typeArguments, typeArgumentsLength),
            argumentNames != null ? arguments!.sublist(0, arguments.length - argumentNames.length) : arguments,
            argumentNames != null ? _NamedArgumentsMap(arguments!, argumentNames) : null);

  @pragma("vm:external-name", "NoSuchMethodError_existingMethodSignature")
  external static String? _existingMethodSignature(Object? receiver, String methodName, int invocationType);
  ...
  String toString() {
    ...
    if (localInvocation is _InvocationMirror) {
      ...
      var level = (localInvocation._type >> _InvocationMirror._LEVEL_SHIFT) & _InvocationMirror._LEVEL_MASK;
      ...
      String? existingSig = _existingMethodSignature(_receiver, memberName, localInvocation._type);
      String argsMsg = existingSig != null ? " with matching arguments" : "";

      String kindBuf = "function";
      if (kind >= 0 && kind < 5) {
        kindBuf = (const ["method", "getter", "setter", "getter or setter", "variable"])[kind];
      }
